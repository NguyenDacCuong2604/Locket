  ...
  return (
    <View style={{
        ...
        <View style={{
            ...
            <View style={{
                ...
                <TouchableOpacity onPress={() => navigation.goBack()}>
                    <Ionic name='close' style={{fontSize:20, color:'white', opacity:0.7}}/>
                </TouchableOpacity>
            </View>
        </View>
        
        <Image source={image} style={{
            position:'absolute', width:"100%", height:500
        }}/>
        ...
        <View style={{
            ...
            <TouchableOpacity onPress={() => navigation.goBack()}>
                <Feather name='navigation' style={{fontSize:30, color:'white', paddingLeft:8}} />
            </TouchableOpacity>
        </View>
